...
class AdherentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adherent" do
    assert_difference("Adherent.count") do
      post adherents_url, params: { adherent: { first_name: @adherent.first_name, id: @adherent.id, last_name: @adherent.last_name } }
    end
  ...
  test "should update adherent" do
    patch adherent_url(@adherent), params: { adherent: { first_name: @adherent.first_name, id: @adherent.id, last_name: @adherent.last_name } }
